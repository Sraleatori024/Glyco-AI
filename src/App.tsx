      ...
      <OnboardingView
        ...
        onComplete={(newProfile) => {
          const mergedProfile: UserProfile = {
            ...
            name: newProfile.name || profile?.name || "Paciente",
            age: newProfile.age || 35,
            gender: newProfile.gender || "Masculino",
            height: newProfile.height || 170,
            weight: newProfile.weight || 70,
            diabetesType: newProfile.diabetesType || "tipo2",
            medications: Array.isArray(newProfile.medications) ? newProfile.medications : [],
            usesInsulin: !!newProfile.usesInsulin,
            insulinTypes: Array.isArray(newProfile.insulinTypes) ? newProfile.insulinTypes : [],
            targetGlucoseMinJejum: newProfile.targetGlucoseMinJejum || 70,
            targetGlucoseMaxJejum: newProfile.targetGlucoseMaxJejum || 130,
            targetGlucoseMaxPosPrandial: newProfile.targetGlucoseMaxPosPrandial || 180,
            goals: Array.isArray(newProfile.goals) ? newProfile.goals : [],
